 ...
 * Usage:
 *   node scripts/db/migrate-chat-attachments.js           (perform migration)
 *   node scripts/db/migrate-chat-attachments.js --dry-run (show changes only)
 *   node scripts/db/migrate-chat-attachments.js --report  (summary without modifying)
 */
